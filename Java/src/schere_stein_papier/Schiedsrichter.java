...
public class Schiedsrichter extends Thread {
	...
	private void print() {
		...
		System.out.println("1"+"\t"+this.spieler_1_stats.get("gewonnen")+"\t"+this.spieler_1_stats.get("unentschieden")+"\t"+this.spieler_1_stats.get("verloren"));
		System.out.println("2"+"\t"+this.spieler_2_stats.get("gewonnen")+"\t"+this.spieler_2_stats.get("unentschieden")+"\t"+this.spieler_2_stats.get("verloren"));
	}
}
